...
def preprocess(file_path):
    ...
    df = pd.read_csv('./bird_detection_interface/prediction_models/naive_bayes/predict.csv')
...
def process_naive_bayes(file_path):
    X=preprocess(file_path)
    loaded_model = pickle.load(open('./bird_detection_interface/prediction_models/naive_bayes/naive.sav', 'rb'))
